...
def keep(
    ...
    **kwargs: Dict[str, Any]
    ...
    In general, if more complex arguments are required, it is best not to track these. Instead, it is better to wrap the
    function inside a sub-function that takes theses arguments.
...
def eval(
    ...
    refer to each other. eval() ensures some basic rules such as no circular references, and will eventually
